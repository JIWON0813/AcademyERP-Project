...
public class VacationController {
    ...
    @PutMapping("/Vacation")  
    public int VacationPut (@RequestBody VacationEntity param){
        return VacationService.VacationPut(param);
    }

    @DeleteMapping("/Vacation/{no}")  
    public int VacationDelete (@PathVariable("no") int no){
        return VacationService.VacationDelete(no);
    }
